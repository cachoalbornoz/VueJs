    ...
    <a-row>
        <a-col :xs="{ span: 24 }" :sm="{ span: 12, offset: 6 }">
            ...
            <a-form ref="formRef" :model="formState" name="basicRegister" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" autocomplete="off" @finish="onFinish" @finishFailed="onFinishFailed">
                ...
                <a-form-item :wrapper-col="{ span: 8, offset: 16 }" :disabled="useStore.loadingUser">
                    <a-button type="primary" html-type="submit">Registrase</a-button>
...
const onFinish = async (values) => {
    await useStore.registerUser(formState.email, formState.password)
}
